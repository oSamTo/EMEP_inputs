...
folname_from <- "outputs/NFCv2/BASE/UKEIRE/NAEI/i2025/EMEP4UKv5.0/annual/TPannual/allISO/archive" # nolint
names(folname_from) <- "from"
emis_yr_from <- 2023
map_yr_from <- 2023

folname_to <- "outputs/NFCv2/BASE/UKEIRE/NAEI/i2025/EMEP4UKv5.0/annual/TPannual/allISO" # nolint
names(folname_to) <- "to"
emis_yr_to <- 2023
map_yr_to <- 2023
