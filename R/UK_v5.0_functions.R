...
EMEP_UKEIRE_v5.0 <- function(y, v_pollutants, time_dim = c("annual","month","yday"), 
  ...
  fname_ncdf <- create_NETCDF_uk(y, v_pollutants, folname, naei_inv,
...
create_NETCDF_uk <- function(y, v_pollutants, folname, naei_inv,
                             v_EMEP_sec, time_dim, uk_agg_schema){
  
  if(time_dim == "annual"){
    
    fname <- create_NETCDF_uk_annual(y, v_pollutants, folname, naei_inv, 
...
create_NETCDF_uk_annual <- function(y, v_pollutants, folname, naei_inv,
                                    v_EMEP_sec, time_dim, uk_agg_schema){
  ...
  # create netcdf name
  nc_filename <- paste0(folname,"/UKEIRE_", naei_inv,"inv_", y,"emis_0.01.nc")
